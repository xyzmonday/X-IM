...
;layui.define(["layer", "laytpl", "upload"], function (i) {
    var a = "3.7.1 Pro", e = layui.$, t = layui.layer, n = layui.laytpl, l = layui.device(), s = "layui-show",
    ...
    var x, b, w, k, C, S = function (i, a, n) {
        ...
        if (a[0]) {
            ...
            return "none" === w.css("display") && w.show(), k && t.close(k.attr("times")), 1 !== s.find("li").length || o[0] || (d || w.css("width", 800), s.css({height: w.height()}).show(), c.css("margin-left", "200px")), o[0] || (s.append(n(v).render(l)), c.append(n(f).render(l)), I(i), E()), O(s.find(".layim-chatlist-" + i.type + i.id)), o[0] || P(), $(i), Q(), C
        }
        l.first = !0;
        var u = C = t.open({
            type: 1,
            ...
            success: function (a) {
                w = a, a.css({
                    "min-width": "500px",
                    "min-height": "420px"
                }), I(i), "function" == typeof i.success && i.success(a), Q(), R(a), $(i), P(), q(), layui.each(r.chatChange, function (i, a) {
                    a && a(_())
